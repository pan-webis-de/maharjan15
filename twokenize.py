...
if __name__ == "__main__":
    print(tokenizeRawTweetText("""It is what it is, difícil de traducir pero algo así como Qué le vamos a hacer. I'm sick and can't go to the party but it is what it is :-)."""))
    emo=re.compile(emoticon)
    if emo.match(''':)'''):
